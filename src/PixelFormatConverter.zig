...
pub fn convert(allocator: std.mem.Allocator, source: *const color.PixelStorage, destination_format: PixelFormat) Image.ConvertError!color.PixelStorage {
    ...
    switch (conversion_id) {
        ...
        // Indexed -> Sega BGR222
        conversionId(.indexed1, .sega_bgr222) => IndexedToRgbColor(.indexed1, .sega_bgr222).convert(source, &destination),
        conversionId(.indexed2, .sega_bgr222) => IndexedToRgbColor(.indexed2, .sega_bgr222).convert(source, &destination),
        conversionId(.indexed4, .sega_bgr222) => IndexedToRgbColor(.indexed4, .sega_bgr222).convert(source, &destination),
        conversionId(.indexed8, .sega_bgr222) => IndexedToRgbColor(.indexed8, .sega_bgr222).convert(source, &destination),
        conversionId(.indexed16, .sega_bgr222) => IndexedToRgbColor(.indexed16, .sega_bgr222).convert(source, &destination),

        // Indexed -> Sega BGR444
        conversionId(.indexed1, .sega_bgr444) => IndexedToRgbColor(.indexed1, .sega_bgr444).convert(source, &destination),
        conversionId(.indexed2, .sega_bgr444) => IndexedToRgbColor(.indexed2, .sega_bgr444).convert(source, &destination),
        conversionId(.indexed4, .sega_bgr444) => IndexedToRgbColor(.indexed4, .sega_bgr444).convert(source, &destination),
        conversionId(.indexed8, .sega_bgr444) => IndexedToRgbColor(.indexed8, .sega_bgr444).convert(source, &destination),
        conversionId(.indexed16, .sega_bgr444) => IndexedToRgbColor(.indexed16, .sega_bgr444).convert(source, &destination),
        ...
        // Grayscale -> Sega BGR222
        conversionId(.grayscale1, .sega_bgr222) => GrayscaleToRgbColor(.grayscale1, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale2, .sega_bgr222) => GrayscaleToRgbColor(.grayscale2, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale4, .sega_bgr222) => GrayscaleToRgbColor(.grayscale4, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale8, .sega_bgr222) => GrayscaleToRgbColor(.grayscale8, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale16, .sega_bgr222) => GrayscaleToRgbColor(.grayscale16, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale8Alpha, .sega_bgr222) => GrayscaleAlphaToRgbColor(.grayscale8Alpha, .sega_bgr222).convert(source, &destination),
        conversionId(.grayscale16Alpha, .sega_bgr222) => GrayscaleAlphaToRgbColor(.grayscale16Alpha, .sega_bgr222).convert(source, &destination),

        // Grayscale -> Sega BGR444
        conversionId(.grayscale1, .sega_bgr444) => GrayscaleToRgbColor(.grayscale1, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale2, .sega_bgr444) => GrayscaleToRgbColor(.grayscale2, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale4, .sega_bgr444) => GrayscaleToRgbColor(.grayscale4, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale8, .sega_bgr444) => GrayscaleToRgbColor(.grayscale8, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale16, .sega_bgr444) => GrayscaleToRgbColor(.grayscale16, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale8Alpha, .sega_bgr444) => GrayscaleAlphaToRgbColor(.grayscale8Alpha, .sega_bgr444).convert(source, &destination),
        conversionId(.grayscale16Alpha, .sega_bgr444) => GrayscaleAlphaToRgbColor(.grayscale16Alpha, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgb332, .sega_bgr222) => RgbColorToRgbColor(.rgb332, .sega_bgr222).convert(source, &destination),
        conversionId(.rgb332, .sega_bgr444) => RgbColorToRgbColor(.rgb332, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.sega_grb333, .sega_bgr222) => RgbColorToRgbColor(.sega_grb333, .sega_bgr222).convert(source, &destination),
        conversionId(.sega_grb333, .sega_bgr444) => RgbColorToRgbColor(.sega_grb333, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.sega_bgr333, .sega_bgr222) => RgbColorToRgbColor(.sega_bgr333, .sega_bgr222).convert(source, &destination),
        conversionId(.sega_bgr333, .sega_bgr444) => RgbColorToRgbColor(.sega_bgr333, .sega_bgr444).convert(source, &destination),
        ...
        // sega_bgr222 -> Indexed
        conversionId(.sega_bgr222, .indexed1) => try RgbColorToIndexed(.sega_bgr222, .indexed1).convert(allocator, source, &destination),
        conversionId(.sega_bgr222, .indexed2) => try RgbColorToIndexed(.sega_bgr222, .indexed2).convert(allocator, source, &destination),
        conversionId(.sega_bgr222, .indexed4) => try RgbColorToIndexed(.sega_bgr222, .indexed4).convert(allocator, source, &destination),
        conversionId(.sega_bgr222, .indexed8) => try RgbColorToIndexed(.sega_bgr222, .indexed8).convert(allocator, source, &destination),
        conversionId(.sega_bgr222, .indexed16) => try RgbColorToIndexed(.sega_bgr222, .indexed16).convert(allocator, source, &destination),

        // sega_bgr222 -> Grayscale
        conversionId(.sega_bgr222, .grayscale1) => RgbColorToGrayscale(.sega_bgr222, .grayscale1).convert(source, &destination),
        conversionId(.sega_bgr222, .grayscale2) => RgbColorToGrayscale(.sega_bgr222, .grayscale2).convert(source, &destination),
        conversionId(.sega_bgr222, .grayscale4) => RgbColorToGrayscale(.sega_bgr222, .grayscale4).convert(source, &destination),
        conversionId(.sega_bgr222, .grayscale8) => RgbColorToGrayscale(.sega_bgr222, .grayscale8).convert(source, &destination),
        conversionId(.sega_bgr222, .grayscale8Alpha) => RgbColorToGrayscaleAlpha(.sega_bgr222, .grayscale8Alpha).convert(source, &destination),
        conversionId(.sega_bgr222, .grayscale16Alpha) => RgbColorToGrayscaleAlpha(.sega_bgr222, .grayscale16Alpha).convert(source, &destination),

        // sega_bgr222 -> RGB + Colorf32
        conversionId(.sega_bgr222, .rgb332) => RgbColorToRgbColor(.sega_bgr222, .rgb332).convert(source, &destination),
        conversionId(.sega_bgr222, .sega_grb333) => RgbColorToRgbColor(.sega_bgr222, .sega_grb333).convert(source, &destination),
        conversionId(.sega_bgr222, .sega_bgr333) => RgbColorToRgbColor(.sega_bgr222, .sega_bgr333).convert(source, &destination),
        conversionId(.sega_bgr222, .sega_bgr444) => RgbColorToRgbColor(.sega_bgr222, .sega_bgr444).convert(source, &destination),
        conversionId(.sega_bgr222, .rgb555) => RgbColorToRgbColor(.sega_bgr222, .rgb555).convert(source, &destination),
        conversionId(.sega_bgr222, .rgb565) => RgbColorToRgbColor(.sega_bgr222, .rgb565).convert(source, &destination),
        conversionId(.sega_bgr222, .rgb24) => RgbColorToRgbColor(.sega_bgr222, .rgb24).convert(source, &destination),
        conversionId(.sega_bgr222, .rgba32) => RgbColorToRgbaColor(.sega_bgr222, .rgba32).convert(source, &destination),
        conversionId(.sega_bgr222, .bgr555) => RgbColorToRgbColor(.sega_bgr222, .bgr555).convert(source, &destination),
        conversionId(.sega_bgr222, .bgr24) => RgbColorToRgbColor(.sega_bgr222, .bgr24).convert(source, &destination),
        conversionId(.sega_bgr222, .bgra32) => RgbColorToRgbaColor(.sega_bgr222, .bgra32).convert(source, &destination),
        conversionId(.sega_bgr222, .rgb48) => RgbColorToRgbColor(.sega_bgr222, .rgb48).convert(source, &destination),
        conversionId(.sega_bgr222, .rgba64) => RgbColorToRgbaColor(.sega_bgr222, .rgba64).convert(source, &destination),
        conversionId(.sega_bgr222, .float32) => rgbColorToColorf32(.sega_bgr222, source, &destination),

        // sega_bgr444 -> Indexed
        conversionId(.sega_bgr444, .indexed1) => try RgbColorToIndexed(.sega_bgr444, .indexed1).convert(allocator, source, &destination),
        conversionId(.sega_bgr444, .indexed2) => try RgbColorToIndexed(.sega_bgr444, .indexed2).convert(allocator, source, &destination),
        conversionId(.sega_bgr444, .indexed4) => try RgbColorToIndexed(.sega_bgr444, .indexed4).convert(allocator, source, &destination),
        conversionId(.sega_bgr444, .indexed8) => try RgbColorToIndexed(.sega_bgr444, .indexed8).convert(allocator, source, &destination),
        conversionId(.sega_bgr444, .indexed16) => try RgbColorToIndexed(.sega_bgr444, .indexed16).convert(allocator, source, &destination),

        // sega_bgr444 -> Grayscale
        conversionId(.sega_bgr444, .grayscale1) => RgbColorToGrayscale(.sega_bgr444, .grayscale1).convert(source, &destination),
        conversionId(.sega_bgr444, .grayscale2) => RgbColorToGrayscale(.sega_bgr444, .grayscale2).convert(source, &destination),
        conversionId(.sega_bgr444, .grayscale4) => RgbColorToGrayscale(.sega_bgr444, .grayscale4).convert(source, &destination),
        conversionId(.sega_bgr444, .grayscale8) => RgbColorToGrayscale(.sega_bgr444, .grayscale8).convert(source, &destination),
        conversionId(.sega_bgr444, .grayscale8Alpha) => RgbColorToGrayscaleAlpha(.sega_bgr444, .grayscale8Alpha).convert(source, &destination),
        conversionId(.sega_bgr444, .grayscale16Alpha) => RgbColorToGrayscaleAlpha(.sega_bgr444, .grayscale16Alpha).convert(source, &destination),

        // sega_bgr222 -> RGB + Colorf32
        conversionId(.sega_bgr444, .rgb332) => RgbColorToRgbColor(.sega_bgr222, .rgb332).convert(source, &destination),
        conversionId(.sega_bgr444, .sega_grb333) => RgbColorToRgbColor(.sega_bgr222, .sega_grb333).convert(source, &destination),
        conversionId(.sega_bgr444, .sega_bgr333) => RgbColorToRgbColor(.sega_bgr222, .sega_bgr333).convert(source, &destination),
        conversionId(.sega_bgr444, .sega_bgr222) => RgbColorToRgbColor(.sega_bgr444, .sega_bgr222).convert(source, &destination),
        conversionId(.sega_bgr444, .rgb555) => RgbColorToRgbColor(.sega_bgr222, .rgb555).convert(source, &destination),
        conversionId(.sega_bgr444, .rgb565) => RgbColorToRgbColor(.sega_bgr222, .rgb565).convert(source, &destination),
        conversionId(.sega_bgr444, .rgb24) => RgbColorToRgbColor(.sega_bgr222, .rgb24).convert(source, &destination),
        conversionId(.sega_bgr444, .rgba32) => RgbColorToRgbaColor(.sega_bgr222, .rgba32).convert(source, &destination),
        conversionId(.sega_bgr444, .bgr555) => RgbColorToRgbColor(.sega_bgr222, .bgr555).convert(source, &destination),
        conversionId(.sega_bgr444, .bgr24) => RgbColorToRgbColor(.sega_bgr222, .bgr24).convert(source, &destination),
        conversionId(.sega_bgr444, .bgra32) => RgbColorToRgbaColor(.sega_bgr222, .bgra32).convert(source, &destination),
        conversionId(.sega_bgr444, .rgb48) => RgbColorToRgbColor(.sega_bgr222, .rgb48).convert(source, &destination),
        conversionId(.sega_bgr444, .rgba64) => RgbColorToRgbaColor(.sega_bgr222, .rgba64).convert(source, &destination),
        conversionId(.sega_bgr444, .float32) => rgbColorToColorf32(.sega_bgr222, source, &destination),
        ...
        conversionId(.rgb555, .sega_bgr222) => RgbColorToRgbColor(.rgb555, .sega_bgr222).convert(source, &destination),
        conversionId(.rgb555, .sega_bgr444) => RgbColorToRgbColor(.rgb555, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgb565, .sega_bgr222) => RgbColorToRgbColor(.rgb565, .sega_bgr222).convert(source, &destination),
        conversionId(.rgb565, .sega_bgr444) => RgbColorToRgbColor(.rgb565, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgb24, .sega_bgr222) => RgbColorToRgbColor(.rgb24, .sega_bgr222).convert(source, &destination),
        conversionId(.rgb24, .sega_bgr444) => RgbColorToRgbColor(.rgb24, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgba32, .sega_bgr222) => RgbaColorToRgbColor(.rgba32, .sega_bgr222).convert(source, &destination),
        conversionId(.rgba32, .sega_bgr444) => RgbaColorToRgbColor(.rgba32, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.bgr24, .sega_bgr222) => RgbColorToRgbColor(.bgr24, .sega_bgr222).convert(source, &destination),
        conversionId(.bgr24, .sega_bgr444) => RgbColorToRgbColor(.bgr24, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.bgra32, .sega_bgr222) => RgbaColorToRgbColor(.bgra32, .sega_bgr222).convert(source, &destination),
        conversionId(.bgra32, .sega_bgr444) => RgbaColorToRgbColor(.bgra32, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgb48, .sega_bgr222) => RgbColorToRgbColor(.rgb48, .sega_bgr222).convert(source, &destination),
        conversionId(.rgb48, .sega_bgr444) => RgbColorToRgbColor(.rgb48, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.rgba64, .sega_bgr222) => RgbaColorToRgbColor(.rgba64, .sega_bgr222).convert(source, &destination),
        conversionId(.rgba64, .sega_bgr444) => RgbaColorToRgbColor(.rgba64, .sega_bgr444).convert(source, &destination),
        ...
        conversionId(.float32, .sega_grb333) => colorf32ToRgbColor(.sega_grb333, source, &destination),
        conversionId(.float32, .sega_bgr333) => colorf32ToRgbColor(.sega_bgr333, source, &destination),
        conversionId(.float32, .sega_bgr222) => colorf32ToRgbColor(.sega_bgr222, source, &destination),
        conversionId(.float32, .sega_bgr444) => colorf32ToRgbColor(.sega_bgr444, source, &destination),
