...
test "Read leroycep1 properly" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "../test-suite/tests/fixtures/png/leroycep1.png");
    defer file.close();
...
test "Read leroycep2 properly" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "../test-suite/tests/fixtures/png/leroycep2.png");
    defer file.close();
...
test "Read leroycep3 properly" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "../test-suite/tests/fixtures/png/leroycep3.png");
    defer file.close();
...
test "Read leroycep4 properly" {
    const file = try helpers.testOpenFile(helpers.zigimg_test_allocator, "../test-suite/tests/fixtures/png/leroycep4.png");
    defer file.close();
