...
test "Read basn0g02 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn0g02.png");
    defer file.close();
...
test "Read basn0g04 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn0g04.png");
    defer file.close();
...
test "Read basn0g08 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn0g08.png");
    defer file.close();
...
test "Read basn0g16 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn0g16.png");
    defer file.close();
...
test "Read basn2c08 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn2c08.png");
    defer file.close();
...
test "Read basn2c16 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn2c16.png");
    defer file.close();
...
test "Read basn3p01 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn3p01.png");
    defer file.close();
...
test "Read basn3p02 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn3p02.png");
    defer file.close();
...
test "Read basn3p04 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn3p04.png");
    defer file.close();
...
test "Read basn3p08 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn3p08.png");
    defer file.close();
...
test "Read basn4a08 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn4a08.png");
    defer file.close();
...
test "Read basn4a16 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn4a16.png");
    defer file.close();
...
test "Read basn6a08 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn6a08.png");
    defer file.close();
...
test "Read basn6a16 data properly" {
    const file = try helpers.testOpenFile(helpers.fixtures_path ++ "png/basn6a16.png");
    defer file.close();
